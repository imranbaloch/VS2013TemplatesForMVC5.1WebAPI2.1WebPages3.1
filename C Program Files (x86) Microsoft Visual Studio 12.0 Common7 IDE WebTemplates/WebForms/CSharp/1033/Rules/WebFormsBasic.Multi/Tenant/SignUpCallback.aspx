<%@ Page Title="Welcome" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SignUpCallback.aspx.cs" Inherits="$safeprojectname$.Tenant.SignUpCallback" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <asp:Button runat="server" name="submit" value="Sign In" Text="Sign In" class="btn btn-default" OnClick="SignIn_Click" />
    </div>
</asp:Content>
