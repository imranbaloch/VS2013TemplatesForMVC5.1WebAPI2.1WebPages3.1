<%@ Page Title="Sign Up" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SignUp.aspx.vb" Inherits="$safeprojectname$.Tenant.SignUp" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <asp:Button ID="Button1" runat="server" name="submit" value="Sign Up" Text="Sign Up" class="btn btn-default" OnClick="SignUp_Click" />
    </div>
</asp:Content>
